...
def disassemble_from_binary (binary_vector):
    '''
    ...
    if instruction_type == 'U_TYPE':
        ...
        immediate_value = as_thirty_two_bit & 0xFFFFF000
        return '{0} x{1},0x{2:08x}'.format(instruction_name, rd, immediate_value)
        ...
        return '{0} x{1},0x{2:08x}'.format(instruction_name, rd, u_immediate)
